...
const TAILWIND_TINTS = [
    "50","100","200","300","400","500","600","700","800","900","950",
] as const;

function getColorList(prefix:string):string[] {
  return TAILWIND_COLORS.map(( color:string )=> {
    return TAILWIND_TINTS.map((tint:string)=> {
      return `${prefix}-${color}-${tint}`;
    })
  }).flat();
}
...
].concat(getColorList("bg"))

export const TAILWIND_FROM_COLOR_CLASSES = [
    "from-inherit","from-current","from-transparent","from-black","from-white"
].concat(getColorList("from"));

export const TAILWIND_TO_COLOR_CLASSES = [
    "to-inherit","to-current","to-transparent","to-black","to-white"
].concat(getColorList("to"));
...
export const TAILWIND_CLASSES = [
    ...
    ... TAILWIND_FROM_COLOR_CLASSES,
    ... TAILWIND_TO_COLOR_CLASSES,
